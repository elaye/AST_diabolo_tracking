...
void gestureRecognition::update(ofPoint p){
...
void gestureRecognition::loadTrainingData(){
    if( trainingData.loadDatasetFromFile("TrainingData.txt") ){
        infoText = "Training data loaded from file TrainingData.txt";
...
int gestureRecognition::getGesture(){
    int g;
    g = pipeline.getPredictedClassLabel();
    return g;
}